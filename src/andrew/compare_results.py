...
def main(args):
    ...
    print(combined_chirp_attributes)
    ...
    # total_subseq_count_all = sum(most_common_subsequences(idiom_label_sequences['cluster'].values, LENGTH, subseq_type=SUBSEQ_TYPE).values())
    # total_subseq_count_exp1 = sum(most_common_subsequences(idiom_label_sequences.loc[idiom_label_sequences["original_df"] == 1]['cluster'].values, LENGTH, subseq_type=SUBSEQ_TYPE).values())
    # total_subseq_count_exp2 = sum(most_common_subsequences(idiom_label_sequences.loc[idiom_label_sequences["original_df"] == 2]['cluster'].values, LENGTH, subseq_type=SUBSEQ_TYPE).values())
    ...
    ignore_columns = ["index", "OriginalIndex", "file_id", "chirp_idx", "original_df", "cluster"]
    ...
    plt.figure(figsize=(10, 8))
    idiom_chirp_attributes['cluster'] = chirp_labels
    exp_to_plot = 2
    ...
    for i in range(NUM_CLUSTERS):
        cluster_points = idiom_chirp_attributes_embedded[idiom_chirp_attributes['cluster'] == i]
        ...
        first_exp_cluster_points = first_exp_attributes_embedded[idiom_chirp_attributes['cluster'][:second_exp_first_row] == i]
        second_exp_cluster_points = second_exp_attributes_embedded[idiom_chirp_attributes['cluster'][second_exp_first_row:] == i]
        if exp_to_plot == 1:
    ...
    first_exp_clusters = idiom_chirp_attributes.loc[idiom_chirp_attributes["original_df"] == 1]['cluster'].values
    second_exp_clusters = idiom_chirp_attributes.loc[idiom_chirp_attributes["original_df"] == 2]['cluster'].values
