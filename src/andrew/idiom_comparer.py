...
class IdiomComparer():
    ...
    def most_common_cluster(self, idiom_label_sequences):
        """
        Compute the most frequently occurring clusters across idioms.

        This method identifies the most common cluster labels appearing in
        idiom sequences for:
        ...
        -------
        pandas.DataFrame
            Table showing the most common clusters and their counts across
            the combined dataset and each experiment.
        """
        SUBSEQ_LENGTH = 1
    ...
    def most_common_transitions(self, idiom_label_sequences):
        ...
        -------
        pandas.DataFrame
            A formatted dataframe showing the most common cluster transitions
